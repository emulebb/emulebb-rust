...
mod tests {
    ...
    fn pending_registry_drains_timed_out_reasks() {
        ...
        // Not yet timed out.
        assert!(registry.drain_timed_out(start + Duration::from_secs(5), Duration::from_secs(30)).is_empty());
        // Past the timeout -> drained as a UDP failure.
        let timed_out = registry.drain_timed_out(start + Duration::from_secs(31), Duration::from_secs(30));
