...
use super::{
    ...
    OP_SEARCHRESULT, OP_SERVER_DESC_REQ, OP_SERVER_DESC_RES, OP_SERVERIDENT, OP_SERVERLIST,
    OP_SERVERMESSAGE, OP_SERVERSTATUS, ResolvedServerEntry, ServerSession,
};
...
fn server_opcode_name(opcode: u8) -> &'static str {
    match opcode {
        ...
        OP_SERVER_DESC_REQ => "OP_SERVER_DESC_REQ",
        OP_SERVER_DESC_RES => "OP_SERVER_DESC_RES",
        OP_REJECT => "OP_REJECT",
        _ => "UNKNOWN",
    }
}
