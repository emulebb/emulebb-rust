use super::{
    ...
    OP_GLOBSEARCHREQ3, OP_GLOBSEARCHRES, OP_GLOBSERVSTATRES, OP_IDCHANGE, OP_LOGINREQUEST,
    OP_OFFERFILES, OP_PACKEDPROT, PendingBackgroundServerSearch, ResolvedServerEntry,
    ...
    encode_source_request, encode_udp_search_request, format_server_flags,
