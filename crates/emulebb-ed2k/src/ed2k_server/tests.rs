use super::{
    ...
    EMULE_VERSION_UPDATE, Ed2kFoundSource, Ed2kHash, Ed2kSearchFile, Ed2kServerSourceBatchTarget,
    ...
    TAGTYPE_STRING, TAGTYPE_UINT8, TAGTYPE_UINT16, TAGTYPE_UINT32, TAGTYPE_UINT64,
