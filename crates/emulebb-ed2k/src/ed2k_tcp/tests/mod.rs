...
use super::{
    ...
    Ed2kSessionSource, Ed2kTransport, Ed2kTransportMode, EmuleTcpPacket, FirewallCheckUdpRequest,
    HELLO_NICKNAME, HelloBuddySnapshot, OP_ACCEPTUPLOADREQ, OP_AICHANSWER, OP_AICHFILEHASHANS,
    OP_AICHFILEHASHREQ, OP_AICHREQUEST, OP_ANSWERSOURCES, OP_ANSWERSOURCES2, OP_ASKSHAREDDENIEDANS,
    OP_ASKSHAREDDIRS, OP_ASKSHAREDFILES, OP_ASKSHAREDFILESANSWER, OP_ASKSHAREDFILESDIR,
    OP_BUDDYPING, OP_BUDDYPONG, OP_CALLBACK, OP_CANCELTRANSFER, OP_CHANGE_CLIENT_ID,
    OP_CHANGE_SLOT, OP_CHATCAPTCHAREQ, OP_CHATCAPTCHARES, OP_COMPRESSEDPART, OP_EDONKEYPROT,
    OP_EMULEINFO, OP_EMULEINFOANSWER, OP_EMULEPROT, OP_END_OF_DOWNLOAD, OP_FILEDESC,
    OP_FILEREQANSNOFIL, OP_FILESTATUS, OP_FWCHECKUDPREQ, OP_HASHSETANSWER2, OP_HASHSETREQUEST2,
    OP_HELLO, OP_HELLOANSWER,
    OP_KAD_FWTCPCHECK_ACK, OP_MESSAGE, OP_MULTIPACKET_EXT, OP_MULTIPACKET_EXT2,
