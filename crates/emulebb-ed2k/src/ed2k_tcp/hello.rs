...
use super::{
    ...
    EMULE_ADVERTISED_KAD_VERSION, EMULE_CRYPT_REQUESTS, EMULE_CRYPT_SUPPORTS, EMULE_INFO_FEATURES,
    EMULE_PROTOCOL_VERSION, EMULE_SECURE_IDENT_VERSION, EMULE_VERSION_MAJOR, EMULE_VERSION_MINOR,
