...
/// eMuleBB-MFC's frozen `LANG_ENGLISH` Unicode->lower-case map, restricted to
/// the code points whose lower form differs from the code point itself (873 of
/// the 0x10000 UTF-16 entries), sorted by upper code point for binary search.
///
/// The oracle lower-cases keyword words through `KadTagStrMakeLower`
/// (kademlia/io/DataIO.cpp:499-521), which maps each UTF-16 code unit through a
/// single hardcoded table `s_awcLowerMap` (loaded from the `WideCharLowerMap.bin`
/// resource, `res\WideCharLowerMap.bin`). The header comment there is explicit:
/// it deliberately does NOT use any locale-dependent lower-casing so that every
/// client on the network shares the exact same character mapping and thus the
/// same md4 keyword hash. This table is copied verbatim from that resource.
const KAD_KEYWORD_LOWER_MAP: &[(u16, u16)] = &[
    ...
    (0x01B5, 0x01B6), (0x01B7, 0x0292), (0x01B8, 0x01B9), (0x01BC, 0x01BD), (0x01C4, 0x01C6), (0x01C7, 0x01C9),
    (0x01CA, 0x01CC), (0x01CD, 0x01CE), (0x01CF, 0x01D0), (0x01D1, 0x01D2), (0x01D3, 0x01D4), (0x01D5, 0x01D6),
    ...
    (0x01F1, 0x01F3), (0x01F4, 0x01F5), (0x01F6, 0x0195), (0x01F7, 0x01BF), (0x01F8, 0x01F9), (0x01FA, 0x01FB),
    ...
    (0x022C, 0x022D), (0x022E, 0x022F), (0x0230, 0x0231), (0x0232, 0x0233), (0x023B, 0x023C), (0x023D, 0x019A),
    (0x0241, 0x0242), (0x0243, 0x0180), (0x0244, 0x0289), (0x0245, 0x028C), (0x0246, 0x0247), (0x0248, 0x0249),
    (0x024A, 0x024B), (0x024C, 0x024D), (0x024E, 0x024F), (0x0386, 0x03AC), (0x0388, 0x03AD), (0x0389, 0x03AE),
    (0x038A, 0x03AF), (0x038C, 0x03CC), (0x038E, 0x03CD), (0x038F, 0x03CE), (0x0391, 0x03B1), (0x0392, 0x03B2),
    (0x0393, 0x03B3), (0x0394, 0x03B4), (0x0395, 0x03B5), (0x0396, 0x03B6), (0x0397, 0x03B7), (0x0398, 0x03B8),
    (0x0399, 0x03B9), (0x039A, 0x03BA), (0x039B, 0x03BB), (0x039C, 0x03BC), (0x039D, 0x03BD), (0x039E, 0x03BE),
    (0x039F, 0x03BF), (0x03A0, 0x03C0), (0x03A1, 0x03C1), (0x03A3, 0x03C3), (0x03A4, 0x03C4), (0x03A5, 0x03C5),
    (0x03A6, 0x03C6), (0x03A7, 0x03C7), (0x03A8, 0x03C8), (0x03A9, 0x03C9), (0x03AA, 0x03CA), (0x03AB, 0x03CB),
    (0x03D8, 0x03D9), (0x03DA, 0x03DB), (0x03DC, 0x03DD), (0x03DE, 0x03DF), (0x03E0, 0x03E1), (0x03E2, 0x03E3),
    (0x03E4, 0x03E5), (0x03E6, 0x03E7), (0x03E8, 0x03E9), (0x03EA, 0x03EB), (0x03EC, 0x03ED), (0x03EE, 0x03EF),
    ...
    (0x0510, 0x0511), (0x0512, 0x0513), (0x0531, 0x0561), (0x0532, 0x0562), (0x0533, 0x0563), (0x0534, 0x0564),
    (0x0535, 0x0565), (0x0536, 0x0566), (0x0537, 0x0567), (0x0538, 0x0568), (0x0539, 0x0569), (0x053A, 0x056A),
    (0x053B, 0x056B), (0x053C, 0x056C), (0x053D, 0x056D), (0x053E, 0x056E), (0x053F, 0x056F), (0x0540, 0x0570),
    (0x0541, 0x0571), (0x0542, 0x0572), (0x0543, 0x0573), (0x0544, 0x0574), (0x0545, 0x0575), (0x0546, 0x0576),
    (0x0547, 0x0577), (0x0548, 0x0578), (0x0549, 0x0579), (0x054A, 0x057A), (0x054B, 0x057B), (0x054C, 0x057C),
    (0x054D, 0x057D), (0x054E, 0x057E), (0x054F, 0x057F), (0x0550, 0x0580), (0x0551, 0x0581), (0x0552, 0x0582),
    (0x0553, 0x0583), (0x0554, 0x0584), (0x0555, 0x0585), (0x0556, 0x0586), (0x10A0, 0x2D00), (0x10A1, 0x2D01),
    (0x10A2, 0x2D02), (0x10A3, 0x2D03), (0x10A4, 0x2D04), (0x10A5, 0x2D05), (0x10A6, 0x2D06), (0x10A7, 0x2D07),
    (0x10A8, 0x2D08), (0x10A9, 0x2D09), (0x10AA, 0x2D0A), (0x10AB, 0x2D0B), (0x10AC, 0x2D0C), (0x10AD, 0x2D0D),
    (0x10AE, 0x2D0E), (0x10AF, 0x2D0F), (0x10B0, 0x2D10), (0x10B1, 0x2D11), (0x10B2, 0x2D12), (0x10B3, 0x2D13),
    (0x10B4, 0x2D14), (0x10B5, 0x2D15), (0x10B6, 0x2D16), (0x10B7, 0x2D17), (0x10B8, 0x2D18), (0x10B9, 0x2D19),
    (0x10BA, 0x2D1A), (0x10BB, 0x2D1B), (0x10BC, 0x2D1C), (0x10BD, 0x2D1D), (0x10BE, 0x2D1E), (0x10BF, 0x2D1F),
    (0x10C0, 0x2D20), (0x10C1, 0x2D21), (0x10C2, 0x2D22), (0x10C3, 0x2D23), (0x10C4, 0x2D24), (0x10C5, 0x2D25),
    ...
    (0x1FB8, 0x1FB0), (0x1FB9, 0x1FB1), (0x1FBA, 0x1F70), (0x1FBB, 0x1F71), (0x1FBC, 0x1FB3), (0x1FC3, 0x1FCC),
    (0x1FC8, 0x1F72), (0x1FC9, 0x1F73), (0x1FCA, 0x1F74), (0x1FCB, 0x1F75), (0x1FD8, 0x1FD0), (0x1FD9, 0x1FD1),
    (0x1FDA, 0x1F76), (0x1FDB, 0x1F77), (0x1FE8, 0x1FE0), (0x1FE9, 0x1FE1), (0x1FEA, 0x1F7A), (0x1FEB, 0x1F7B),
    (0x1FEC, 0x1FE5), (0x1FF3, 0x1FFC), (0x1FF8, 0x1F78), (0x1FF9, 0x1F79), (0x1FFA, 0x1F7C), (0x1FFB, 0x1F7D),
    ...
    (0x24CE, 0x24E8), (0x24CF, 0x24E9), (0x2C00, 0x2C30), (0x2C01, 0x2C31), (0x2C02, 0x2C32), (0x2C03, 0x2C33),
    (0x2C04, 0x2C34), (0x2C05, 0x2C35), (0x2C06, 0x2C36), (0x2C07, 0x2C37), (0x2C08, 0x2C38), (0x2C09, 0x2C39),
    (0x2C0A, 0x2C3A), (0x2C0B, 0x2C3B), (0x2C0C, 0x2C3C), (0x2C0D, 0x2C3D), (0x2C0E, 0x2C3E), (0x2C0F, 0x2C3F),
    (0x2C10, 0x2C40), (0x2C11, 0x2C41), (0x2C12, 0x2C42), (0x2C13, 0x2C43), (0x2C14, 0x2C44), (0x2C15, 0x2C45),
    (0x2C16, 0x2C46), (0x2C17, 0x2C47), (0x2C18, 0x2C48), (0x2C19, 0x2C49), (0x2C1A, 0x2C4A), (0x2C1B, 0x2C4B),
    (0x2C1C, 0x2C4C), (0x2C1D, 0x2C4D), (0x2C1E, 0x2C4E), (0x2C1F, 0x2C4F), (0x2C20, 0x2C50), (0x2C21, 0x2C51),
    (0x2C22, 0x2C52), (0x2C23, 0x2C53), (0x2C24, 0x2C54), (0x2C25, 0x2C55), (0x2C26, 0x2C56), (0x2C27, 0x2C57),
    (0x2C28, 0x2C58), (0x2C29, 0x2C59), (0x2C2A, 0x2C5A), (0x2C2B, 0x2C5B), (0x2C2C, 0x2C5C), (0x2C2D, 0x2C5D),
    (0x2C2E, 0x2C5E), (0x2C60, 0x2C61), (0x2C62, 0x026B), (0x2C63, 0x1D7D), (0x2C64, 0x027D), (0x2C65, 0x023A),
    (0x2C66, 0x023E), (0x2C67, 0x2C68), (0x2C69, 0x2C6A), (0x2C6B, 0x2C6C), (0x2C75, 0x2C76), (0x2C80, 0x2C81),
    ...
    (0x2CE2, 0x2CE3), (0xFF21, 0xFF41), (0xFF22, 0xFF42), (0xFF23, 0xFF43), (0xFF24, 0xFF44), (0xFF25, 0xFF45),
...
/// Lower-case a Kad keyword word exactly like `KadTagStrMakeLower`
/// (kademlia/io/DataIO.cpp:499-521), which passes each UTF-16 code unit through
/// the frozen `s_awcLowerMap` table (see `KAD_KEYWORD_LOWER_MAP`). This is NOT
/// Rust's `str::to_lowercase()`: that follows the live Unicode case-folding
/// rules, which diverge from the frozen table for code points such as U+0130
/// (İ), U+1E9E (ẞ), the U+212A Kelvin sign and the U+00B5 micro sign — all of
/// which the oracle leaves unchanged — and can also expand a single char into
/// several. Any such divergence changes the md4(word) keyword hash and makes a
/// non-ASCII / CJK filename unfindable cross-client. Each BMP code point maps as
/// the oracle does; every code point absent from the table (which includes
/// astral chars, seen by the oracle as identity-mapped surrogate code units) is
...
pub(crate) fn kad_keyword_lowercase(word: &str) -> String {
    word.chars()
        .map(|character| {
            ...
            match KAD_KEYWORD_LOWER_MAP.binary_search_by(|&(upper, _)| u32::from(upper).cmp(&code)) {
                Ok(index) => {
                    char::from_u32(u32::from(KAD_KEYWORD_LOWER_MAP[index].1)).unwrap_or(character)
                }
                Err(_) => character,
            }
        })
...
pub(crate) fn significant_keyword_words(query: &str) -> Vec<String> {
    ...
    if words.is_empty() {
        vec![kad_keyword_lowercase(query)]
    } else {
        words
    }
}
...
pub(crate) fn keyword_target(query: &str) -> NodeId {
    let first_word = exact_ed2k_hash_query_token(query).unwrap_or_else(|| {
        significant_keyword_words(query)
            .into_iter()
            .next()
            .unwrap_or_else(|| kad_keyword_lowercase(query))
    });
